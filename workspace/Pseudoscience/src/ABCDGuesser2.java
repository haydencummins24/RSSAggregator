...
//            if (in.FormatChecker.canParseDouble(s)) {
     ...
     *
     * @param est
     *            the final approximation of u.
     * @param u
     *            the number being attempted to estimate.
     * @param exp1
     *            the exponent of w.
     * @param exp2
     *            the exponent of x.
     ...
     *            the output stream.
     */
    private static void printfinal(double est, double u, double exp1,
            double exp2, double exp3, double exp4, SimpleWriter out) {
        out.println("Exponents are, w ^ " + exp1 + " x ^ " + exp2 + " y ^ "
                + exp3 + " z ^ " + exp4);

        out.println("Best Approximation: " + est);

        out.print("Relative error = " + Math.abs((u - est) / u));
    ...
    public static void main(String[] args) {
        ...
        double c = 0;
        double d = 0;
        final double[] jager = { -5.0, -4.0, -3.0, -2.0, -1.0, -1.0 / 2.0,
        ...
        printfinal(finest, u, exp1, exp2, exp3, exp4, out);
